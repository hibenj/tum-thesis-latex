...
%		\draw[->] (7) -- (f);
	...
	\end{tikzpicture} 
\caption{Scheme of a simple sequential circuit layout after placement and routing} \label{fig:sequential_gate_sample}
\end{figure}
