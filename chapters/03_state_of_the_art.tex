...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\begin{scope}[xshift=2.7cm, yshift=-2.2cm, rotate=90]
			...
			\node[text=black] (A4) at (2.5,0.1) {$BL_{in}$};
			\node[text=black] (A1) at (0.25,-0.7) {$2$};
		\end{scope}
		
		\begin{scope}[xshift=4.6cm, rotate = 270]
			\draw[rounded corners] (-0.05, -0.1 - 0.85) rectangle (2.3-0.05, 2.3-0.1 - 0.85){};
			\node[text=black] (A1) at (1.1+0.85,1.1) {$1$};
		\end{scope}
		...
		\end{scope}
		\begin{scope}[xshift=4.6cm, yshift=-2.3cm, rotate=270]
			\draw[rounded corners] (-0.05, -0.1 - 0.85) rectangle (2.3-0.05, 2.3-0.1 - 0.85){};
			\node[text=black] (A1) at (1.1+0.85,1.1) {$4$};
		\end{scope}
		...
		\end{scope}
		\begin{scope}[xshift=2.3cm, yshift=-4.6cm, rotate=270]
			\draw[rounded corners] (-0.05, -0.1 - 0.85) rectangle (2.3-0.05, 2.3-0.1 - 0.85){};
			...
			\node[text=black] (A1) at (1.1+0.85,1.1) {$4$};
		\end{scope}
		\begin{scope}[xshift=5cm, yshift=-6.8cm, rotate=90]
			\draw[rounded corners] (-0.05, -0.1 - 0.85) rectangle (2.3-0.05, 2.3-0.1 - 0.85){};
