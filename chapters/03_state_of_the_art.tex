...
%	\centering
%	%AND
%\begin{tikzpicture}[rotate=270, scale=1.1, every node/.style={scale=1.2}]
%	\draw[rounded corners] (-0.05, -0.1 - 0.85) rectangle (2.3-0.05, 2.3-0.1 - 0.85){};
%	
%	\foreach \x/\y in {0.9/0.9, 0.9/0.45, 0.9/0, 0.9/-0.45, 0.9/-0.9, 0/0, 0.45/0, 1.35/0}
%	{
...
%	\node[text=black] (A1) at (0.25,-0.7) {$2$};
%\end{tikzpicture}%
%\begin{tikzpicture}[rotate=0, scale=1.1, every node/.style={scale=1.2}]
%	\draw[rounded corners] (-0.05, -0.1 - 0.85) rectangle (2.3-0.05, 2.3-0.1 - 0.85){};
%	\node[text=black] (four) at (1.95 ,-0.65) {$3$};
%\end{tikzpicture}%
%
%\begin{tikzpicture}[rotate=180, scale=1.1, every node/.style={scale=1.2}]
%	\draw[rounded corners] (-0.05, -0.1 - 0.85) rectangle (2.3-0.05, 2.3-0.1 - 0.85){};
%	
%	\foreach \x/\y in {0.9/0.9, 0.9/0.45, 0.9/0, 0/0, 0.45/0}
%	{
